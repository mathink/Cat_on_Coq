...
# coq_makefile Adjunction.v Category.v Cone.v Example_Adj_FreeMonoid_List.v Example_limit_colimit.v Functor.v HomFunctor.v Monad.v Natrans.v Setoid.v Sets.v 
#
