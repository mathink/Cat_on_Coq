...
# coq_makefile Setoid.v Category.v Functor.v Natrans.v Adjunction.v Monad.v Cone.v Example_limit_colimit.v Example_Adj_FreeMonoid_List.v HomFunctor.v Sets.v 
#
...
VFILES:=Setoid.v\
  ...
  Monad.v\
  Cone.v\
  Example_limit_colimit.v\
  Example_Adj_FreeMonoid_List.v\
  HomFunctor.v\
  Sets.v
